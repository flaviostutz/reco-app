                ...
                {!this.viewModel.showVideoPicker &&
                    <View style={{ flex: 1 }}>
                        <RNCamera
                            ...
                            notAuthorizedView={
                                <View>
                                    <Text>Reco was not authorized to access the camera</Text>
                                </View>
                            }
                        />
                        ...
                        <SafeAreaView style={{ flex: 1 }}>
                            ...
                            <View style={{ paddingTop:4, paddingLeft: 13, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                <View style={{ flex:1, height: 38, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                    <Image style={{ height: 20, width: 60 }}
                                        resizeMode='contain'
                                        source={require('../resources/reco-h-transp1.png')} />
                                    {(this.viewModel.state!='recording' || this.viewModel.recordLed) &&
                                        <Image style={{ height: 20, width: 20 }}
                                            resizeMode='contain'
                                            source={require('../resources/reco-h-transp2.png')} />
                                    }
                                </View>
